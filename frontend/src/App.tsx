...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 to-slate-100">
      {/* 컴팩트 헤더 */}
      <header className="bg-gradient-to-r from-sky-600 to-sky-700 shadow-lg border-b border-sky-800 sticky top-0 z-20">
      ...
      <div>
            ...
            {result && (
              <div className="hidden sm:flex items-center space-x-2 text-sm text-sky-100">
