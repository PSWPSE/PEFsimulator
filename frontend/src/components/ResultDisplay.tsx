...
export const ResultDisplay: React.FC<ResultDisplayProps> = ({ result }) => {
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      {/* 전체 요약 */}
      <div className="bg-gradient-to-br from-indigo-50 via-indigo-100 to-indigo-200 rounded-2xl p-6 sm:p-8 border border-indigo-200 shadow-lg">
        <h3 className="text-lg sm:text-xl font-bold text-indigo-800 mb-6 flex items-center">
